...
class QuatroScreen extends StatefulWidget {
  const QuatroScreen({Key? key}) : super(key: key);

  @override
  _QuatroScreenState createState() => _QuatroScreenState();
}

class _QuatroScreenState extends State<QuatroScreen> {
  int _counterA = 0;
  int _counterB = 0;
  String valor = "";
